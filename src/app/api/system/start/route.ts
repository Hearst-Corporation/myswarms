...
export async function POST(): Promise<NextResponse> {
  ...
  // NodeJS.ProcessEnv est Record<string, string | undefined> — on filtre les undefined.
  ...
  try {
    const spawnOpts: SpawnOptions = {
      ...
      // Cast nécessaire : SpawnOptions.env attend NodeJS.ProcessEnv (avec NODE_ENV requis),
      // mais on passe intentionnellement une allowlist restreinte sans NODE_ENV exposé.

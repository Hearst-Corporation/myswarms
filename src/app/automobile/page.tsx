...
// UUID du template global Automobile — Recherche véhicule
...
export default async function AutomobilePage() {
  ...
  return (
    <>
      ...
      >
        <div>
          <h1 className="ct-title">Automobile</h1>
      ...
      {!loadError && total === 0 && (
        <div className="ct-card" style={{ textAlign: "center", padding: `${SPACING.xxl}px` }}>
          ...
          <p className="ct-card-body" style={{ marginBottom: SPACING.xl }}>
            Lancez votre première analyse en remplissant le formulaire du template Automobile — Recherche véhicule.
          </p>
